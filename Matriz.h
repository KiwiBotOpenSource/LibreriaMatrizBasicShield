...
void imprimirPixel(byte i0, byte j0, int tiempo); //Funcion para imprimir pixel en (i ,j) durante un tiempo determinado
void imprimirNumero(byte valor); //Funcion para imprimir un numero
void imprimirNumero(byte valor, int tiempo); //Funcion para imprimir un numero durante un tiempo determinado
void imprimirNumero(byte valor, double tiempo); //Funcion para imprimir un numero durante un tiempo determinado siendo posible la duracion 1.5 segundos
void imprimirLinea(byte i2, byte j2, byte i3, byte j3); //Funcion para imprmir una linea desde Iinicio, Jinicio hasta Ifinal, Ifinal
void limpiarMatriz(); //Funcion para apagar todos los leds
void nuevoPunto(byte i, byte j); //Funcion para añadir un nuevo punto que se encendera en la matriz
void borrarPunto(byte i, byte j); //Funcion para eliminar un nuevo punto de los que se encienden en la matriz
void imprimirMatriz(); //Funcion para encender los puntos anteriormente definidos
void imprimirMatriz(int tiempo); //Funcion para encender los puntos anteriormente definidos durante un tiempo definido
void imprimirMatriz(double tiempo); //Funcion para encender los puntos anteriormente definidos durante un tiempo definido siendo posible la duracion 1.5 segundos
...
private:
void enviarDatos(byte fila, byte columna);
